// pmh_fe/src/views/MediaConsole/NewDailyReview/BudgetRecommendation/BudgetRecommendationAction.js
...
const BudgetRecommendationAction = ({ recommendation, handleRemoveClick, onEditRecommendation }) => {
  const actionListItems = [
    {
      actionBtnName: 'Edit',
      actionIconImg: `bg-edit.svg`,
      onClickHandler: onEditRecommendation,
    },
    {
      actionBtnName: 'View',
            ...
            return (
              <li className={styles['bg-action__dropdown__dropDownItem-mb']}>
                <button
                  ...
                  type='button'
                  onClick={() => item.onClickHandler(recommendation)}
                >
                  <img
...
export default BudgetRecommendationAction;